      ...
      <section className="py-20 md:py-32">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center items-center gap-4">
            ...
            <Button asChild size="lg" className="font-bold bg-primary/10 text-primary hover:bg-primary/20 rounded-[30px] hover:scale-105 hover:shadow-lg transition-all">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="text-left shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-border/50">
        ...
        <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
              {futureFeatures.map((feature, index) => (
                <Card key={index} className="bg-card shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-border/50 p-6 rounded-xl">
