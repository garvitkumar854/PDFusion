...
export const services: Service[] = [
    {
      icon: <Combine className="text-purple-600 dark:text-purple-400" />,
    ...
    {
      icon: <Scissors className="text-green-600 dark:text-green-400" />,
    ...
    {
      icon: <ListOrdered className="text-cyan-600 dark:text-cyan-400" />,
    ...
    {
      icon: <Image className="text-blue-600 dark:text-blue-400" />,
     ...
     {
      icon: <Droplets className="text-sky-600 dark:text-sky-400" />,
    ...
    {
      icon: <FileText className="text-teal-600 dark:text-teal-400" />,
    ...
    {
      icon: <RotateCw className="text-indigo-600 dark:text-indigo-400" />,
    ...
    {
      icon: <Hash className="text-pink-600 dark:text-pink-400" />,
     ...
     {
      icon: <LayoutGrid className="text-orange-600 dark:text-orange-400" />,
