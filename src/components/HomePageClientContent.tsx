                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    ...
                    >
                        <Link href={service.href} className="h-full block group relative">
                          ...
                          <Card className="relative text-left shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 bg-card/50 dark:bg-card/20 backdrop-blur-lg h-full flex flex-col">
                    ...
                    <div className="container mx-auto px-4 text-center">
                        ...
                        {futureFeatures.map((feature, index) => (
                            ...
                            <div className="group relative h-full">
                                <div className="absolute -inset-0.5 bg-gradient-to-r from-primary to-blue-400 rounded-2xl blur opacity-0 group-hover:opacity-75 transition duration-300"></div>
                                <Card className="relative bg-card/50 dark:bg-card/20 backdrop-blur-lg shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 p-4 md:p-6 flex flex-col h-full">
