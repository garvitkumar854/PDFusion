...
import { Menu, ChevronDown, Combine, Scissors, FileArchive, Image as ImageIcon, FileText, RotateCw, Hash, ListOrdered, Code, FileX2 } from 'lucide-react';
...
const services = [
    ...
    { href: "/remove-pages", label: "Remove Pages", icon: <FileX2 className="mr-2 h-4 w-4" /> },
